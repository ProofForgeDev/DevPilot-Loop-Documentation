...
>
> **版本**: 2.0.0 · **Skill 总数**: 8 · **总测试数**: 367 · **覆盖率**: ~95%
...
**总计**: 14,693 行 Python 代码（含框架、测试、运行时）· 274 个测试用例 · ~95% 覆盖率
...
```bash
# 安装命令（8 个 Skill，通过 poc/skills/ 路径）
for skill in defect-triage code-root-cause fix-generator test-runner canary-release postmortem-capture orchestrator lifecycle; do
...
全部 8 个 Skill 均已通过 367 个 pytest 测试。
