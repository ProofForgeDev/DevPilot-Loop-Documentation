...
| 协同层 | 7 Agent 协作、上下文传递 | Matrix 房间 | 6 Workers |
| 能力层 | 6 Skill 执行 | skills.sh 生态 | 6 个标准 skill 包 |
...
| skills.sh 生态 | 6 个 Skill 按标准格式打包，可安装 | Skill 工程 25% |
