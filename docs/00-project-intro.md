...
**方案**：基于 AgentTeams（原 HiClaw）构建"1 Manager + 6 Worker"协同闭环。Manager（DevLead）负责拆解与调度；Intake、Analyst、Fixer、Verifier、Release、Knowledge 六 Worker 分别承担归并、根因定位、修复执行、测试验证、灰度发布、知识沉淀。全流程由 6 个 Skill 驱动，协作发生在可审计的 Matrix 房间中。
