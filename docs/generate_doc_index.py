...
DOC_INDEX = {
    ...
    "files": {
        ...
        "code": {
            "skills": {
                "code_review": {"lines": 159, "tests": 50},
                "test_generation": {"lines": 138, "tests": 33},
                "doc_writing": {"lines": 156, "tests": 39},
                "security_scan": {"lines": 178, "tests": 40},
                "perf_analysis": {"lines": 182, "tests": 43},
                "deploy_verification": {"lines": 158, "tests": 39},
            },
...
def print_index():
    ...
    print(f"Total Evidence: {sum(DOC_INDEX['files']['evidence'].values())} files")
    print(f"Total Code Lines: ~10,948")
    print(f"Total Test Cases: 330")
    print("\nCategories:")
