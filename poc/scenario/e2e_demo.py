...
====================================
模拟完整 DevPilot Loop 流程：Intake → Analyst → Fixer → Verifier → Release → Knowledge
...
def step_analyst() -> dict:
    ...
    # 模拟静态扫描分析（实际项目中会调用 linter/SAST 工具）
    findings = [
        {
            "id": "SEC-001",
            "severity": "HIGH",
...
def step_verifier() -> dict:
    ...
    verifications = [
        ...
        },
        {
            ...
            "passed": "TODO: Add input validation" in fixed_content or "def validate_input" in fixed_content,
